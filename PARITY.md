...
|---|---:|---:|---|
| Substrate/FRAME verified-inference settlement runtime | 🔴 | HIGH | API is not the FLOP runtime |
| Runtime ActiveValidators authority | 🔴 | HIGH | Current MockValidatorRegistry is local/test-only |
| Runtime ProcessedTasks state | 🔴 | HIGH | API replay mechanisms do not prove runtime parity |
| OnProofVerified | 🔴 | HIGH | No runtime event/settlement hook |
| Runtime G_n credit | 🔴 | HIGH | API accepts/binds gn_weight but does not credit runtime |
| Full FLOP runtime settlement | 🔴 | HIGH | API acceptance is not runtime settlement |
...
| Runtime ActiveValidators membership | 🔴 | HIGH | Local/test registry only | NOT IMPLEMENTED |
| Runtime unsigned inherent | 🔴 | HIGH | HTTP analogue is not runtime inherent | NOT IMPLEMENTED |
| Runtime settlement | 🔴 | HIGH | No runtime credit/event | NOT IMPLEMENTED |
...
| Capability | Status | Risk | Exact nuance |
|---|---:|---:|---|
| quote_verified field | 🟢 | HIGH | Signed boolean claim; NOT actual quote verification |
| event_log_verified field | 🟢 | HIGH | Signed boolean claim; NOT event-log replay |
| DCAP verification | 🔴 | HIGH | No DCAP/dcap-qvl implementation |
| dstack verification | 🔴 | HIGH | No dstack implementation |
| Intel TDX quote parsing | 🔴 | HIGH | No quote parser/verifier |
| NVIDIA CC verification | 🔴 | HIGH | No hardware attestation verifier |
| Event-log replay | 🔴 | HIGH | Not implemented |
| RTMR3/MRTD binding | 🔴 | HIGH | Not implemented |
| Real TEE evidence verification | 🔴 | HIGH | API does not independently verify underlying TEE evidence |
...
| dm-verity measured root | 🔴 | HIGH | Not implemented |
| EROFS + dm-verity verification | 🔴 | HIGH | Not implemented |
| RTMR3/MRTD measurement binding | 🔴 | HIGH | Not implemented |
| Model registry comparison | 🔴 | HIGH | Not implemented |
...
| Real model-execution provenance | 🔴 | HIGH | API does not execute the model |
| Independent output recomputation | 🔴 | HIGH | Tier-3 execution verification absent |
...
| 32-byte representation | 🟢 | LOW | Shape validation |
| ValidatorAttestation binding | 🟢 | LOW | Signed/bound |
| Canonical decode-policy object | 🔴 | MEDIUM | No canonical policy object/derivation |
| Parameter derivation | 🔴 | HIGH | No canonical temperature/top-p/top-k derivation |
| Independent execution verification | 🔴 | HIGH | Not implemented |

**Safe wording:** decode_policy_hash is bound as a claim; canonical derivation/verification is not implemented.
...
| Actual quote verification | 🔴 | HIGH | No real quote parser/verifier |
| External KAT/vector verification | 🔴 | MEDIUM | Not empirically verified against official runtime/vector |
...
| report_data binding | 🟢 | LOW | Included in report_data |
| miner_recv_ms | 🔴 | HIGH | Not implemented |
| miner_done_ms | 🔴 | HIGH | Not implemented |
...
| Actual STARK proof verification | 🔴 | HIGH | Proof JSON is accepted but not cryptographically verified |
| Runtime PendingVerifications semantics | 🔴 | HIGH | Runtime storage/pruning absent |
| Runtime ProcessedTasks mutation | 🔴 | HIGH | Runtime semantics not implemented |
...
| F_eff computation | 🔴 | HIGH | Not implemented |
| G_n = F_eff / 10^9 | 🔴 | HIGH | Not computed |
| hp_poui::flop_meter | 🔴 | HIGH | Official reference not integrated |
| Execution-input meter | 🔴 | HIGH | Required execution-input terms absent |
| Throughput tripwire | 🔴 | HIGH | Not implemented |
| MLPerf ceiling | 🔴 | HIGH | Not implemented here |
| Under-report floor | 🔴 | HIGH | Not implemented here |
| Calibration cap | 🔴 | HIGH | Not implemented |
| G_n unit taxonomy | 🔴 | MEDIUM | Yellow Paper marks E.30 TBD |
| VerifiedTurn | 🔴 | HIGH | Not implemented |
| Aggregate distinct g_n validation | 🔴 | HIGH | Not implemented |
| Runtime G_n credit | 🔴 | HIGH | Not implemented |
...
| Tier-1 TEE verification | 🔴 | HIGH | Not implemented |
| Tier-2 TOPLOC | 🔴 | HIGH | Not implemented |
| Tier-3 optimistic re-execution | 🔴 | HIGH | Not implemented |
| Tier-4 validator quorum | 🟡 | HIGH | API models signatures/quorum, not runtime authority/settlement |
| TOPLOC protocol-to-proof bridge | 🔴 | HIGH | E.43 remains an open item |
...
| FLOP runtime ProcessedTasks | runtime state | 🔴 | Not implemented / not independently verified |
